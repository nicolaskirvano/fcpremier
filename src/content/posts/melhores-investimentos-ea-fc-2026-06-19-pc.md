...
title: "Momentum de Premier League no EA FC em 19/06 — PC"
draft: false
featured: true
tags:
  - investimentos
  ...
  - previsoes
  - pc
description: "Ranking histórico de momentum em 19/06/2026 no PC: Elliot Anderson liderou 7d com +84,2%. Compare preços, 24h/7d, gráfico e limites."
---
...
**Elliot Anderson** liderou o recorte com **+84,2% em 7d** e +9,4% em 24h. Entre 15 cartas, 15 tinham as duas janelas positivas; a mediana semanal foi **+33,3%**.

Os preços destacados iam de **23k coins** a **236k coins**. O ranking descreve momentum observado naquela data; previsão ausente ou inválida aparece como N/D e não confirma uma compra atual.

![Gráfico de variação em 7 dias para os destaques de Momentum de Premier League no EA FC em 19/06 — PC](/charts/melhores-investimentos-ea-fc-2026-06-19-pc.svg)
...
- **Elliot Anderson (86)** — 35k coins, **+84.2% em 7 dias** (+9.4% em 24h). Preço +19% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.

- **Dominik Szoboszlai (87)** — 236k coins, **+68.6% em 7 dias** (+25.5% em 24h). Preço +34% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.
...
- **Matheus Cunha (87)** — 197k coins, **+41.7% em 7 dias** (+23.9% em 24h). Preço +30% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.
...
Elliot Anderson (86, Premier League) lidera, com +84.2% em 7 dias a 35k coins no PC. No recorte, isso descrevia momentum observado, não uma recomendação atual.
...
- [Premier League baratos no EA FC em 19/06 — PC](/posts/jogadores-baratos-ea-fc-2026-06-19-pc/)
- [Premier League no EA FC em 19/06: altas e baixas — PC](/posts/mercado-ea-fc-2026-06-19-pc/)
